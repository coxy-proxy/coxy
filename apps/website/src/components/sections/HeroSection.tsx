  ...
  return (
    ...
    >
      <div className="space-y-6">
        <img src="/header-dark.png" alt="Coxy Logo" className="mx-auto h-26 w-auto" />
        <h1 className="text-3xl md:text-4xl font-extrabold font-serif">GitHub Copilot as OpenAI-compatible APIs</h1>
